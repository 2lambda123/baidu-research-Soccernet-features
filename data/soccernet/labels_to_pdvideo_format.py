...
def main(args):
    # labels_folder = '/home/zhangyuxuan07/PaddleSports/SoccerData/output/annotations'
    # output_folder = '/home/zhangyuxuan07/PaddleSports/SoccerData/output/annotation_for_pdv'
    ...
    # print('num_labels_list with 0 annotations', num_labels_list.count(0))
    # print('num_labels_list with 1 annotations', num_labels_list.count(1))
    # print('num_labels_list with 2 annotations', num_labels_list.count(2))
    # print('num_labels_list with 3 annotations', num_labels_list.count(3))
...
if __name__ == "__main__":
    ...
    parser.add_argument('--clips_folder', type=str, default = '/home/zhangyuxuan07/PaddleSports/SoccerData/smallsetofdata', help = 'Where json annotation files are')
    parser.add_argument('--output_folder', type=str, default = '/home/zhangyuxuan07/PaddleSports/SoccerData/smallsetofdata', help = 'Where label_list.txt and annotation.txt are saved')
