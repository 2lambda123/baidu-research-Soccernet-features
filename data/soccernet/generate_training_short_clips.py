    ...
    for filename in files:
        ...
        while start < duration:
            ...
            command = f'ffmpeg -ss {start_time_str} -i "{filename}" \
                -vf scale=456x256 -c:v libx264 -c:a aac -strict experimental -b:a 98k \
...
if __name__ == "__main__":
    ...
    parser.add_argument('--clips_folder', type=str, default = '/mnt/storage/gait-0/xin/dataset/soccernet_456x256')
